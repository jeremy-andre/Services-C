...
const ProductsOffert = (props: Props) => {
  ...
  return (
    <Flex direction="column" py="1.5rem" gap="1.5rem">
      <Flex justify="space-between" w="100%">
        <Text>Productos en Oferta</Text>
        <Flex cursor="pointer">-minimizar-</Flex>
      </Flex>
      <Flex justify='space-between'>
        {productOfferts.map((producto) => (
          <Flex direction="column" gap="0.5rem" w="32%">
            <Image aspectRatio="1" borderRadius='1rem' src={producto.image} alt="Offert Product" />
