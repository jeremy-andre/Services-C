...
const Services = () => {
  return (
    <Flex justify="center" align="center" gap="2rem" my="2rem">
      {services.map((service) => (
        <Flex
          ...
          gap='1rem'
        >
          <Heading fontSize='1.5rem' h='5rem' textAlign='center' mx='2rem' >{service.title}</Heading>
          <Text fontSize='1rem' h='100%' textAlign='center' >{service.description}</Text>
        </Flex>
      ))}
    </Flex>
  );
